...
def make_layman_crew(stream: bool = False) -> Crew:
    ...
    retrieval_task = Task(
        description=(
            ...
            "Call QdrantHybridSearchTool with this focused query and top_k=3. "
...
def make_lawyer_crew(stream: bool = False) -> Crew:
    ...
    retrieval_task = Task(
        description=(
            ...
            "Call QdrantHybridSearchTool with this focused query, top_k=3, "
...
def make_police_crew(stream: bool = False) -> Crew:
    ...
    retrieval_task = Task(
        description=(
            ...
            "era_filter='naveen_sanhitas', act_filter='none', top_k=3. "
